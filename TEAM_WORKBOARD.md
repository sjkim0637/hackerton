...
| goguma-salad + Codex | `agent/goguma-salad/geo-time-construction` | `experiments/goguma-salad/Geo-Time Construction/` | Geo-Time Construction | 실제 단위세대 통신 DWG를 평형별 통신 배선 2D·3D 객체로 변환한다. | `IN_PROGRESS` | [geo-time-construction](docs/workstreams/geo-time-construction.md) | 2026-09-01 |
