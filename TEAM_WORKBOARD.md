...
| goguma-salad + Codex | `agent/goguma-salad/interior-assets-ui` | `experiments/shinym87/interior/` | Asset 기반 Interior 제품 UI | 제공된 인테리어 Asset을 적용한 홈과 기능 분기, 독립 설정 화면을 구현한다. | `REVIEW` | [interior-assets-ui](docs/workstreams/interior-assets-ui.md) | 2026-09-08 |
