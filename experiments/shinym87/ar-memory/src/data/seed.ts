...
import { stockPhotoUrl } from "../utils/media";
...
export const SEED_POSTS: Post[] = [
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("sakura-path-spring"),
    visibility: "all",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("sakura-path-summer"),
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("sakura-path-autumn"),
    visibility: "all",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("sakura-path-winter"),
    visibility: "neighbors",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("playground-baby"),
    visibility: "neighbors",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("playground-toddler"),
    visibility: "neighbors",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("playground-kid"),
    visibility: "all",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("garden-plant"),
    visibility: "all",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("garden-grow"),
    visibility: "neighbors",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("garden-harvest"),
    visibility: "all",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("pet-trail-morning"),
    visibility: "neighbors",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("pet-trail-greet"),
    visibility: "all",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("pet-trail-snow"),
    visibility: "neighbors",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("pavilion-spring"),
    visibility: "all",
  ...
  post({
    ...
    mediaType: "image",
    mediaUrl: stockPhotoUrl("pavilion-autumn"),
    visibility: "neighbors",
